...
namespace Microsoft.Azure.Management.Profiles.Subscription
{
    ...
    public static partial class SubscriptionsOperationsExtensions
    {
        ...
        /// Subscription Id.
        /// </param>
        public static CanceledSubscriptionId Cancel(this ISubscriptionsOperations operations, bool ignoreResourceCheck, string subscriptionId)
        {
            return operations.CancelAsync(subscriptionId, ignoreResourceCheck).GetAwaiter().GetResult();
        }
        ...
        /// </param>
        public static async Task<CanceledSubscriptionId> CancelAsync(this ISubscriptionsOperations operations, string subscriptionId, bool ignoreResourceCheck, CancellationToken cancellationToken = default(CancellationToken))
        {
            using (var _result = await operations.CancelWithHttpMessagesAsync(subscriptionId, ignoreResourceCheck, null, cancellationToken).ConfigureAwait(false))
            {
                return _result.Body;
            }
        }
