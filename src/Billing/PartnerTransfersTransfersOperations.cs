...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class PartnerTransfersTransfersOperations : IServiceOperations<BillingManagementClient>, IPartnerTransfersTransfersOperations
    {
        /// <summary>
        /// Initializes a new instance of the PartnerTransfersTransfersOperations class.
        /// </summary>
        /// <param name='client'>
        ...
        /// </exception>
        internal PartnerTransfersTransfersOperations(BillingManagementClient client)
        {
            if (client == null)
            {
        ...
        /// </return>
        public async Task<AzureOperationResponse<IPage<TransferDetails>>> ListWithHttpMessagesAsync(string billingAccountName, string billingProfileName, string customerName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/customers/{customerName}/transfers").ToString();
