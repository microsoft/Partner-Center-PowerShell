...
namespace Microsoft.Azure.Management.Billing
{
    ...
    /// </summary>
    internal partial class AvailableBalancesOperations : IServiceOperations<BillingManagementClient>, IAvailableBalancesOperations
    {
        /// <summary>
        ...
        /// </return>
        public async Task<AzureOperationResponse<AvailableBalance>> GetByBillingProfileWithHttpMessagesAsync(string billingAccountName, string billingProfileName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<AvailableBalance>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<AvailableBalance>(_responseContent, Client.DeserializationSettings);
                }
