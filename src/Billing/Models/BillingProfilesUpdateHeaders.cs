...
namespace Microsoft.Azure.Management.Billing.Models
{
    ...
    /// </summary>
    public partial class BillingProfilesUpdateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BillingProfilesUpdateHeaders
        /// class.
        /// </summary>
        public BillingProfilesUpdateHeaders()
        {
            CustomInit();
        }
        ...
        /// seconds.</param>
        public BillingProfilesUpdateHeaders(string location = default(string), string retryAfter = default(string))
        {
            Location = location;
