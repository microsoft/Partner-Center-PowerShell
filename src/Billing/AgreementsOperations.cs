...
namespace Microsoft.Azure.Management.Billing
{
    ...
    internal partial class AgreementsOperations : IServiceOperations<BillingManagementClient>, IAgreementsOperations
    {
        ...
        public async Task<AzureOperationResponse<AgreementListResult>> ListByBillingAccountWithHttpMessagesAsync(string billingAccountName, string expand = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Create Result
            var _result = new AzureOperationResponse<AgreementListResult>();
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Rest.Serialization.SafeJsonConvert.DeserializeObject<AgreementListResult>(_responseContent, Client.DeserializationSettings);
                }
