...
namespace Microsoft.Store.PartnerCenter.Orders
{
    ...
    internal class OrderProvisioningStatusOperations : BasePartnerComponent<Tuple<string, string>>, IOrderProvisioningStatus
    {
        ...
        public ResourceCollection<OrderLineItemProvisioningStatus> Get(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The customer order.</returns>
        public async Task<ResourceCollection<OrderLineItemProvisioningStatus>> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
