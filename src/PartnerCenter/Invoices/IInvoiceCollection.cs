...
namespace Microsoft.Store.PartnerCenter.Invoices
{
    ...
    public interface IInvoiceCollection : IPartnerComponent<string>, IEntireEntityCollectionRetrievalOperations<Invoice, ResourceCollection<Invoice>>, IEntitySelector<IInvoice>
    {
        ...
        ResourceCollection<Invoice> Query(IQuery query, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// </param>
        /// <returns>The invoices that match the given query.</returns>
        Task<ResourceCollection<Invoice>> QueryAsync(IQuery query, CancellationToken cancellationToken = default(CancellationToken));
    }
}