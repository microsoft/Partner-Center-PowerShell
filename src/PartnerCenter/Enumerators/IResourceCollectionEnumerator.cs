...
namespace Microsoft.Store.PartnerCenter.Enumerators
{
    ...
    public interface IResourceCollectionEnumerator<T> where T : ResourceBaseWithLinks<StandardResourceCollectionLinks>
    {
        ...
        Task NextAsync(IRequestContext context = null, CancellationToken cancellationToken = default);
        ...
        Task PreviousAsync(IRequestContext context = null, CancellationToken cancellationToken = default);
    }
}