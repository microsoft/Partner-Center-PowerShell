...
namespace Microsoft.Store.PartnerCenter.Usage
{
    ...
    internal class CustomerUsageRecordCollectionOperations : BasePartnerComponent<string>, ICustomerUsageRecordCollection
    {
        ...
        public ResourceCollection<CustomerMonthlyUsageRecord> Get(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The collection of customer monthly usage records.</returns>
        public async Task<ResourceCollection<CustomerMonthlyUsageRecord>> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
