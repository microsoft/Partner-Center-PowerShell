...
namespace Microsoft.Store.PartnerCenter.Usage
{
    ...
    internal class SubscriptionDailyUsageRecordCollectionOperations : BasePartnerComponent<Tuple<string, string>>, ISubscriptionDailyUsageRecordCollection
    {
        ...
        public ResourceCollection<SubscriptionDailyUsageRecord> Get(CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Collection of subscription daily usage records.</returns>
        public async Task<ResourceCollection<SubscriptionDailyUsageRecord>> GetAsync(CancellationToken cancellationToken = default(CancellationToken))
        {
