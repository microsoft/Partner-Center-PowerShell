...
namespace Microsoft.Store.PartnerCenter.RateCards
{
    ...
    public interface IAzureRateCard : IPartnerComponent<string>
    {
        ...
        AzureRateCard Get(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The Azure rate card for the partner.</returns>
        Task<AzureRateCard> GetAsync(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param
        /// <returns>The Azure rate card for the partner.</returns>
        AzureRateCard GetShared(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param
        /// <returns>The Azure rate card for the partner.</returns>
        Task<AzureRateCard> GetSharedAsync(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
