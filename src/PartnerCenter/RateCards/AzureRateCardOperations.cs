...
namespace Microsoft.Store.PartnerCenter.RateCards
{
    ...
    internal class AzureRateCardOperations : BasePartnerComponent<string>, IAzureRateCard
    {
        ...
        public AzureRateCard Get(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return PartnerService.SynchronousExecute(() => GetAsync(currency, region, cancellationToken));
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The Azure rate card for the partner.</returns>
        public async Task<AzureRateCard> GetAsync(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param
        /// <returns>The Azure rate card for the partner.</returns>
        public AzureRateCard GetShared(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            return PartnerService.SynchronousExecute(() => GetSharedAsync(currency, region, cancellationToken));
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param
        /// <returns>The Azure rate card for the partner.</returns>
        public async Task<AzureRateCard> GetSharedAsync(string currency = null, string region = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            IDictionary<string, string> parameters = new Dictionary<string, string>();
