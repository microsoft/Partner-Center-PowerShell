...
namespace Microsoft.Store.PartnerCenter.Utilization
{
    ...
    public interface IAzureUtilizationCollection : IPartnerComponent<Tuple<string, string>>
    {
        ...
        Task<ResourceCollection<AzureUtilizationRecord>> SeekAsync(string continuationToken, SeekOperation seekOperation = SeekOperation.Next, CancellationToken cancellationToken = default);
    }
}