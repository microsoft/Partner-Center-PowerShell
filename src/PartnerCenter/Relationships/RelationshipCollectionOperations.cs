...
namespace Microsoft.Store.PartnerCenter.Relationships
{
    ...
    internal class RelationshipCollectionOperations : BasePartnerComponent<string>, IRelationshipCollection
    {
        ...
        public ResourceCollection<PartnerRelationship> Get(PartnerRelationshipType partnerRelationshipType, CancellationToken cancellationToken = default(CancellationToken))
        {
            return PartnerService.SynchronousExecute(() => GetAsync(partnerRelationshipType, cancellationToken));
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The partner relationships.</returns>
        public async Task<ResourceCollection<PartnerRelationship>> GetAsync(PartnerRelationshipType partnerRelationshipType, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public ResourceCollection<PartnerRelationship> Query(PartnerRelationshipType partnerRelationshipType, IQuery query, CancellationToken cancellationToken = default(CancellationToken))
        {
            return PartnerService.SynchronousExecute(() => QueryAsync(partnerRelationshipType, query, cancellationToken));
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>The partner relationships that match the given query.</returns>
        public async Task<ResourceCollection<PartnerRelationship>> QueryAsync(PartnerRelationshipType partnerRelationshipType, IQuery query, CancellationToken cancellationToken = default(CancellationToken))
        {
            IDictionary<string, string> parameters = new Dictionary<string, string>
            {
                {
