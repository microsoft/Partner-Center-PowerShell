#
# Module manifest for module 'Partner Center'
#
# Generated by: Microsoft Corporation
#
# Generated on: 10/05/2018
#
...
@{
    ...
    RequiredAssemblies = '.\Microsoft.Store.PartnerCenter.PowerShell.dll', 
                   ...
                   '.\Microsoft.Store.PartnerCenter.Extensions.dll',
                   '.\Microsoft.Store.PartnerCenter.Models.dll',
                   '.\Newtonsoft.Json.dll'
    ...
    NestedModules = @('Microsoft.Store.PartnerCenter.PowerShell.dll')
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'Added support for app only authentication. Added Get-PartnerCustomerBillingProfile and Get-PartnerCustomerCompanyProfile commands. Corrected a conversion issue with the Get-PartnerCustomerUsageSummary command.'
