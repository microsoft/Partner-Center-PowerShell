...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class ComponentsschemasmicrosoftGraphDeviceconfigurationstateallof1
    {
        ...
        /// class.
        /// </summary>
        public ComponentsschemasmicrosoftGraphDeviceconfigurationstateallof1()
        {
            CustomInit();
        }
        ...
        public ComponentsschemasmicrosoftGraphDeviceconfigurationstateallof1(IList<MicrosoftgraphdeviceConfigurationSettingState> settingStates = default(IList<MicrosoftgraphdeviceConfigurationSettingState>), string displayName = default(string), int? version = default(int?), string platformType = default(string), string state = default(string), int? settingCount = default(int?), string userId = default(string), string userPrincipalName = default(string))
        {
        ...
        public IList<MicrosoftgraphdeviceConfigurationSettingState> SettingStates { get; set; }
