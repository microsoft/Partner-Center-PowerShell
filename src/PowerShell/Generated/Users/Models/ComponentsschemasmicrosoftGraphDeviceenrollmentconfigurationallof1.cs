...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    /// </remarks>
    public partial class ComponentsschemasmicrosoftGraphDeviceenrollmentconfigurationallof1
    {
        /// <summary>
        ...
        /// class.
        /// </summary>
        public ComponentsschemasmicrosoftGraphDeviceenrollmentconfigurationallof1()
        {
            CustomInit();
        }
        ...
        /// configuration</param>
        public ComponentsschemasmicrosoftGraphDeviceenrollmentconfigurationallof1(string displayName = default(string), string description = default(string), int? priority = default(int?), System.DateTime? createdDateTime = default(System.DateTime?), System.DateTime? lastModifiedDateTime = default(System.DateTime?), int? version = default(int?), IList<MicrosoftgraphenrollmentConfigurationAssignment> assignments = default(IList<MicrosoftgraphenrollmentConfigurationAssignment>))
        {
