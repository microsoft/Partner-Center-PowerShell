...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class Microsoftgraphnotification
    {
        /// <summary>
        /// Initializes a new instance of the Microsoftgraphnotification class.
        /// </summary>
        public Microsoftgraphnotification()
        {
            CustomInit();
        }
        ...
        /// 'Low'</param>
        public Microsoftgraphnotification(string id = default(string), string targetHostName = default(string), System.DateTime? expirationDateTime = default(System.DateTime?), MicrosoftgraphpayloadTypes payload = default(MicrosoftgraphpayloadTypes), int? displayTimeToLive = default(int?), string priority = default(string), string groupName = default(string), MicrosoftgraphtargetPolicyEndpoints targetPolicy = default(MicrosoftgraphtargetPolicyEndpoints))
        {
            Id = id;
