...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    /// </summary>
    public partial class ComponentsschemasmicrosoftGraphGrouplifecyclepolicyallof1
    {
        /// <summary>
        /// Initializes a new instance of the
        /// ComponentsschemasmicrosoftGraphGrouplifecyclepolicyallof1 class.
        /// </summary>
        public ComponentsschemasmicrosoftGraphGrouplifecyclepolicyallof1()
        {
            CustomInit();
        }
        ...
        /// ComponentsschemasmicrosoftGraphGrouplifecyclepolicyallof1 class.
        /// </summary>
        public ComponentsschemasmicrosoftGraphGrouplifecyclepolicyallof1(int? groupLifetimeInDays = default(int?), string managedGroupTypes = default(string), string alternateNotificationEmails = default(string))
        {
