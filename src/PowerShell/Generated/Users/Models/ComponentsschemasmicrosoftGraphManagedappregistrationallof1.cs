...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class ComponentsschemasmicrosoftGraphManagedappregistrationallof1
    {
        ...
        /// ComponentsschemasmicrosoftGraphManagedappregistrationallof1 class.
        /// </summary>
        ...
        public ComponentsschemasmicrosoftGraphManagedappregistrationallof1(System.DateTime? createdDateTime = default(System.DateTime?), System.DateTime? lastSyncDateTime = default(System.DateTime?), string applicationVersion = default(string), string managementSdkVersion = default(string), string platformVersion = default(string), string deviceType = default(string), string deviceTag = default(string), string deviceName = default(string), string managedDeviceId = default(string), string azureADDeviceId = default(string), string deviceModel = default(string), string deviceManufacturer = default(string), IList<string> flaggedReasons = default(IList<string>), string userId = default(string), object appIdentifier = default(object), string version = default(string), IList<MicrosoftgraphmanagedAppPolicy> appliedPolicies = default(IList<MicrosoftgraphmanagedAppPolicy>), IList<MicrosoftgraphmanagedAppPolicy> intendedPolicies = default(IList<MicrosoftgraphmanagedAppPolicy>), IList<MicrosoftgraphmanagedAppOperation> operations = default(IList<MicrosoftgraphmanagedAppOperation>))
        {
