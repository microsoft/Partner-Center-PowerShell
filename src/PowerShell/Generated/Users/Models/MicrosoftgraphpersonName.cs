...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class MicrosoftgraphpersonName
    {
        /// <summary>
        /// Initializes a new instance of the MicrosoftgraphpersonName class.
        /// </summary>
        public MicrosoftgraphpersonName()
        {
            CustomInit();
        }
        ...
        public MicrosoftgraphpersonName(string id = default(string), string allowedAudiences = default(string), MicrosoftgraphinferenceData inference = default(MicrosoftgraphinferenceData), System.DateTime? createdDateTime = default(System.DateTime?), MicrosoftgraphidentitySet createdBy = default(MicrosoftgraphidentitySet), System.DateTime? lastModifiedDateTime = default(System.DateTime?), MicrosoftgraphidentitySet lastModifiedBy = default(MicrosoftgraphidentitySet), string displayName = default(string), string first = default(string), string initials = default(string), string last = default(string), string languageTag = default(string), string maiden = default(string), string middle = default(string), string nickname = default(string), string suffix = default(string), string title = default(string), MicrosoftgraphyomiPersonName pronunciation = default(MicrosoftgraphyomiPersonName))
        {
            Id = id;
