...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class ComponentsschemasmicrosoftGraphInferenceclassificationoverrideallof1
    {
        ...
        /// 'other'</param>
        public ComponentsschemasmicrosoftGraphInferenceclassificationoverrideallof1(string classifyAs = default(string), MicrosoftgraphemailAddress senderEmailAddress = default(MicrosoftgraphemailAddress))
        {
