...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class MicrosoftgraphmessageRule
    {
        ...
        /// Initializes a new instance of the MicrosoftgraphmessageRule class.
        /// </summary>
        public MicrosoftgraphmessageRule(string id = default(string), string displayName = default(string), int? sequence = default(int?), MicrosoftgraphmessageRulePredicates conditions = default(MicrosoftgraphmessageRulePredicates), MicrosoftgraphmessageRuleActions actions = default(MicrosoftgraphmessageRuleActions), MicrosoftgraphmessageRulePredicates exceptions = default(MicrosoftgraphmessageRulePredicates), bool? isEnabled = default(bool?), bool? hasError = default(bool?), bool? isReadOnly = default(bool?))
        {
            Id = id;
