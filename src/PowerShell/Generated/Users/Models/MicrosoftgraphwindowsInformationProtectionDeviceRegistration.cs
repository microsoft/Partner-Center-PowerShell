...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class MicrosoftgraphwindowsInformationProtectionDeviceRegistration
    {
        /// <summary>
        /// Initializes a new instance of the
        /// MicrosoftgraphwindowsInformationProtectionDeviceRegistration class.
        /// </summary>
        public MicrosoftgraphwindowsInformationProtectionDeviceRegistration()
        {
            CustomInit();
        }
        ...
        /// device.</param>
        public MicrosoftgraphwindowsInformationProtectionDeviceRegistration(string id = default(string), string userId = default(string), string deviceRegistrationId = default(string), string deviceName = default(string), string deviceType = default(string), string deviceMacAddress = default(string), System.DateTime? lastCheckInDateTime = default(System.DateTime?))
        {
            Id = id;
            UserId = userId;
