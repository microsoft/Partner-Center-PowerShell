...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class MicrosoftgraphdeviceConfigurationState
    {
        ...
        public MicrosoftgraphdeviceConfigurationState(string id = default(string), IList<MicrosoftgraphdeviceConfigurationSettingState> settingStates = default(IList<MicrosoftgraphdeviceConfigurationSettingState>), string displayName = default(string), int? version = default(int?), string platformType = default(string), string state = default(string), int? settingCount = default(int?), string userId = default(string), string userPrincipalName = default(string))
        {
            Id = id;
