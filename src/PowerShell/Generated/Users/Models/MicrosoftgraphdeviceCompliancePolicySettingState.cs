...
namespace Microsoft.Store.PartnerCenter.PowerShell.Models
{
    ...
    public partial class MicrosoftgraphdeviceCompliancePolicySettingState
    {
        ...
        /// device</param>
        public MicrosoftgraphdeviceCompliancePolicySettingState(string setting = default(string), string settingName = default(string), string instanceDisplayName = default(string), string state = default(string), long? errorCode = default(long?), string errorDescription = default(string), string userId = default(string), string userName = default(string), string userEmail = default(string), string userPrincipalName = default(string), IList<MicrosoftgraphsettingSource> sources = default(IList<MicrosoftgraphsettingSource>), string currentValue = default(string))
        {
            Setting = setting;
