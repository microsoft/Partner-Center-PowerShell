...
* Authentication
  * Added the ability to invoke [Connect-PartnerCenter](https://github.com/microsoft/Partner-Center-PowerShell/blob/master/docs/help/Connect-PartnerCenter.md) without requiring the creation of an Azure Active Directory application
