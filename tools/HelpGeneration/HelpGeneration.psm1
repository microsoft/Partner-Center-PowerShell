...
function New-PartnerCenterMarkdownHelp
{
    [CmdletBinding()]
    Param
    (
    ...
    $errors = Compare-PartnerCenterMarkdownHelp $HelpFolderPath $NewHelpFolderPath
...
function Compare-PartnerCenterMarkdownHelp
{
    [CmdletBinding()]
    Param
    (
...
function Test-PartnerCenterMarkdownHelp
{
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory = $true, Position = 0)]
...
function New-PartnerCenterMamlHelp
{
    [CmdletBinding()]
    Param
    (
    ...
    $MAML = $dir | ? { $_.FullName -like "*.dll-Help.xml" }

    # Modify the MAML (add spaces between examples)
    $MAML | foreach { Edit-PartnerCenterMamlHelp $_ }
}

function Edit-PartnerCenterMamlHelp
{
    [CmdletBinding()]
    Param
    (
